...
export default function ModalCreateOrder({ visible, onClose, onSuccess }) {
    ...
    // Load products when customer is selected or page changes
    useEffect(() => {
        if (visible && selectedCustomer) {
            loadAvailableProducts();
        }
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [visible, selectedCustomer, productsPage]);
    ...
    const loadAvailableProducts = async () => {
        ...
        try {
            ...
            const data = await catalogService.getCustomerCatalogProducts(selectedCustomer.customer_id, params);
    ...
    const handleCreateOrder = async () => {
        ...
        try {
            const orderData = {
                ...
                shipping_address_number: 1 // Default to first address
            };

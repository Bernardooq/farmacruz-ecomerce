...
const ADVANTAGES_DATA = [
  { icon: faTruckFast, title: 'Entregas Rápidas', text: 'Logística optimizada para recibir tus pedidos en tiempo récord.' },
  { icon: faBoxOpen, title: 'Amplio Catálogo', text: 'Miles de productos de los laboratorios más reconocidos.' },
  { icon: faHeadset, title: 'Soporte Dedicado', text: 'Atención personalizada para resolver todas tus dudas.' }
];
